    ...
    <div className="w-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-brand-green/20 via-brand-dark-base to-brand-dark-base py-20 px-4 md:px-8 flex-grow flex items-center justify-center">
      <div className="max-w-4xl w-full relative">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold font-display text-white mt-3 text-glow-gold">
            SONKO — Guide de la Révolution
          </h1>
          <p className="text-xs text-foreground/50 mt-2 max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-5 glass-panel p-6 rounded-2xl border-l-4 border-l-brand-gold relative shadow-xl space-y-6">
            <div className="flex flex-col items-center text-center pb-4 border-b border-brand-emerald/10">
              ...
              <h3 className="text-md font-bold text-white font-display">Développeur du Projet</h3>
              <span className="text-[10px] font-mono text-brand-gold font-bold uppercase tracking-wider mt-1 bg-brand-green/35 px-2.5 py-1 rounded border border-brand-gold/15">
                Patriote&apos;Dev
              </span>
            </div>
            ...
            <div className="space-y-4 text-xs font-mono">
              <div className="flex flex-col gap-1">
                <span className="text-foreground/45 text-[9px] uppercase font-bold tracking-wider">Contact E-mail</span>
                <a href="mailto:papemakhtaraidara@gmail.com" className="font-bold text-white hover:text-brand-gold transition-colors flex items-center gap-1.5">
                  <Mail className="w-3.5 h-3.5 text-brand-gold" />
                  <span>papemakhtaraidara@gmail.com</span>
                </a>
              </div>

              <div className="flex flex-col gap-1 pt-2 border-t border-brand-emerald/5">
                <span className="text-foreground/45 text-[9px] uppercase font-bold tracking-wider">Portfolio en ligne</span>
                <a href="https://pma-portfolio.vercel.app/" target="_blank" rel="noopener noreferrer" className="font-bold text-white hover:text-brand-gold transition-colors flex items-center gap-1.5">
