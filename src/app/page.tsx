...
import WaveDonationCard from "@/components/wave-donation-card";

// Squelette de chargement pour les composants dynamiques
const LoadingSkeleton = ({ title }: { title: string }) => (
  <div className="w-full h-80 rounded-2xl glass-panel border border-brand-emerald/15 flex flex-col items-center justify-center gap-3 bg-emerald-50/20 dark:bg-brand-green-dark/5">
    <div className="w-8 h-8 rounded-full border-2 border-brand-gold/20 border-t-brand-gold animate-spin" />
    <span className="text-xs font-mono text-foreground/50 tracking-wider">{title}...</span>
  </div>
);
  ...
  return (
    <div className="flex flex-col w-full relative animate-slide-up">
      ...
      <section className="relative w-full bg-brand-dark-base overflow-hidden border-b border-brand-emerald/15">
        {/* Ambient glows */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_40%_50%,_rgba(7,71,47,0.08),_transparent)] dark:bg-[radial-gradient(ellipse_80%_60%_at_40%_50%,_rgba(7,71,47,0.25),_transparent)] pointer-events-none" />
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-gold/5 rounded-full blur-3xl pointer-events-none translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-stretch">
          ...
          <div className="w-full lg:w-[45%] xl:w-[42%] flex-shrink-0 relative order-2 lg:order-1 lg:self-stretch">
            <div className="relative w-full h-[420px] lg:h-full min-h-[480px] overflow-hidden">
              ...
              <div className="hidden lg:block absolute inset-0 bg-gradient-to-l from-brand-dark-base via-brand-dark-base/20 to-transparent pointer-events-none" />
          ...
          <div className="flex-1 flex flex-col justify-center px-6 md:px-12 py-16 lg:py-24 order-1 lg:order-2">
            {/* Eyebrow */}
            <span className="text-[10px] md:text-xs font-mono font-black text-brand-gold uppercase tracking-[0.3em] mb-4 block">
              Sénégal · PASTEF · Président de l&apos;Assemblée Nationale
            </span>

            {/* Big title */}
            <h2 className="font-display font-extrabold leading-[1.05] text-foreground">
            ...
            {/* Sub-tagline */}
            <p className="mt-6 text-sm md:text-base text-foreground/75 max-w-md leading-relaxed font-sans">
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <span className="text-[10px] font-mono text-brand-gold font-bold uppercase tracking-widest">Né le 15 juillet 1974 · Thiès, Sénégal</span>
            </div>
          </div>
      ...
      <section className="relative w-full min-h-[85vh] flex flex-col items-center justify-center py-20 px-4 md:px-8 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-50/60 dark:from-brand-green/35 via-brand-dark-base to-brand-dark-base overflow-hidden">
        {/* Glow lines */}
        ...
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-brand-green/10 dark:bg-brand-green/20 rounded-full blur-3xl pointer-events-none" />

        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          {/* Hero text */}
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 dark:bg-brand-green/30 border border-brand-emerald/25 text-xs text-brand-gold font-bold uppercase tracking-widest mb-6">
              <Sparkles className="w-3.5 h-3.5 animate-spin" style={{ animationDuration: "4s" }} />
              <span>Encyclopédie Officielle & Interactive</span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold font-display leading-[1.1] text-foreground tracking-tight">
              Tout savoir sur <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold via-brand-gold-light to-emerald-700 dark:to-white text-glow-gold">
                Ousmane Sonko
              </span> <br />
              en un seul endroit.
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link
                href="#ask-sonko"
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-50 dark:bg-brand-green/20 border border-brand-emerald/25 text-foreground hover:bg-emerald-100 dark:hover:bg-brand-green/45 font-bold text-sm md:text-base transition-all cursor-pointer"
              >
      ...
      {/* KEY STATS BAR */}
      <section className="bg-emerald-50/70 dark:bg-brand-green-dark/60 border-y border-brand-emerald/15 py-8 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center">
            <span className="text-3xl md:text-4xl font-extrabold font-display text-brand-gold block">1974</span>
            <span className="text-xs text-foreground/60 uppercase tracking-widest font-bold mt-1 block">Naissance</span>
          </div>
          <div className="text-center border-l border-brand-emerald/15">
            ...
            <span className="text-xs text-foreground/60 uppercase tracking-widest font-bold mt-1 block">Création de PASTEF</span>
          </div>
          <div className="text-center border-l border-brand-emerald/15">
            <span className="text-3xl md:text-4xl font-extrabold font-display text-brand-gold block">15,67%</span>
            <span className="text-xs text-foreground/60 uppercase tracking-widest font-bold mt-1 block">3e Présidentielle 2019</span>
          </div>
          <div className="text-center border-l border-brand-emerald/15">
            <span className="text-3xl md:text-4xl font-extrabold font-display text-brand-gold block">2026</span>
            <span className="text-xs text-foreground/60 uppercase tracking-widest font-bold mt-1 block">Président Assemblée</span>
          </div>
        </div>
      </section>

      {/* WAVE DONATION BANNER & QR CODE */}
      <section className="py-12 px-4 md:px-8 bg-gradient-to-r from-emerald-50/50 dark:from-brand-green-dark/40 via-brand-dark-base to-emerald-50/50 dark:to-brand-green-dark/40 relative z-10 border-b border-brand-emerald/15">
      ...
      <section id="timeline-360" className="py-20 px-4 md:px-8 bg-brand-dark-base relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold font-display text-foreground mt-3">
              Sonko Timeline 360°
            </h2>
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-b from-brand-dark-base to-emerald-50/40 dark:to-brand-green-dark/20 relative border-t border-brand-emerald/10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center mb-12">
      ...
      <section id="grand-quiz" className="py-20 px-4 md:px-8 bg-gradient-to-b from-brand-dark-base to-emerald-50/40 dark:to-brand-green-dark/20 relative border-t border-brand-emerald/10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center mb-12">
        ...
        <div className="max-w-5xl mx-auto glass-panel p-6 md:p-8 rounded-2xl relative shadow-2xl overflow-hidden">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-1">
              ...
              <h3 className="text-2xl font-bold text-foreground font-display mb-4">Discours Historique du 1er Congrès de PASTEF</h3>
