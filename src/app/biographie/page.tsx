      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="border-b border-brand-emerald/15 pb-px mb-12">
          <div className="relative">
            ...
            >
              <div className="flex gap-2 bg-emerald-50/80 dark:bg-brand-green-dark/30 p-1.5 rounded-2xl border border-brand-emerald/15 whitespace-nowrap min-w-max mx-auto">
                {tabs.map((tab) => {
                  const Icon = tab.icon;
            ...
            >
              ...
              <div className="md:col-span-5 glass-panel p-6 rounded-2xl border-l-4 border-l-brand-gold shadow-xl">
                ...
                <div className="space-y-4 text-sm font-mono">
                  <div className="flex justify-between border-b border-brand-emerald/10 pb-2">
                    ...
                    <span className="font-bold text-foreground text-right">Ousmane Sonko</span>
                  </div>
                  <div className="flex justify-between border-b border-brand-emerald/10 pb-2">
                    <span className="text-foreground/50">DATE DE NAISSANCE :</span>
                    <span className="font-bold text-foreground text-right">15 Juillet 1974</span>
                  </div>
                  <div className="flex justify-between border-b border-brand-emerald/10 pb-2">
                    <span className="text-foreground/50">LIEU DE NAISSANCE :</span>
                    <span className="font-bold text-foreground text-right">Thiès, Sénégal</span>
                  </div>
                  <div className="flex justify-between border-b border-brand-emerald/10 pb-2">
                  ...
                  <div className="flex justify-between border-b border-brand-emerald/10 pb-2">
                    ...
                    <span className="font-bold text-foreground text-right">PASTEF (Président réélu pour 6 ans)</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-foreground/50">NATIONALITÉ :</span>
                    <span className="font-bold text-foreground text-right">Sénégalaise</span>
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-7 space-y-6">
                <div className="glass-panel p-6 rounded-2xl">
                  <h3 className="text-xl font-bold text-foreground font-display mb-3">Enfance & Histoire Familiale</h3>
                ...
                <div className="glass-panel p-6 rounded-2xl border-l-4 border-l-brand-emerald">
                  <h3 className="text-xl font-bold text-foreground font-display mb-3">Éducation Religieuse & Valeurs</h3>
                  <p className="text-sm text-foreground/80 leading-relaxed font-sans">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="glass-panel p-6 rounded-2xl relative">
                  <span className="text-xs font-mono font-bold text-brand-gold/80 block mb-2">ÉCOLE PRIMAIRE & SECONDAIRE</span>
                  <h3 className="text-lg font-bold text-foreground mb-3 font-display">Cursus Scolaire Régional</h3>
                ...
                <div className="glass-panel p-6 rounded-2xl relative">
                  <span className="text-xs font-mono font-bold text-brand-gold/80 block mb-2">MAÎTRISE EN DROIT</span>
                  <h3 className="text-lg font-bold text-foreground mb-3 font-display">Université Gaston Berger de Saint-Louis (1993-1999)</h3>
                  <p className="text-sm text-foreground/75 leading-relaxed font-sans">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                <div className="md:col-span-8 glass-panel p-6 rounded-2xl border-l-4 border-l-brand-gold">
                  <span className="text-xs font-mono font-bold text-brand-gold/80 block mb-2">CONCOURS ET DIPLÔME MAJOR</span>
                  <h3 className="text-lg font-bold text-foreground mb-3 font-display">L&apos;École Nationale d&apos;Administration (ENA) du Sénégal</h3>
                  <p className="text-sm text-foreground/75 leading-relaxed font-sans">
                ...
                <div className="md:col-span-4 bg-emerald-50/70 dark:bg-brand-green-dark/30 border border-brand-emerald/15 p-6 rounded-2xl flex flex-col justify-between items-center text-center">
                  <Award className="w-12 h-12 text-brand-gold mb-3 animate-pulse" />
                  <h4 className="font-bold text-foreground text-sm">Master 2 UCAD</h4>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-4 glass-panel p-6 rounded-2xl flex flex-col justify-between">
                  <h4 className="font-bold text-foreground text-sm font-display mb-3">Réformes Fiscales Proposées</h4>
                  ...
                  <div className="mt-4 pt-3 border-t border-brand-emerald/10 text-center">
                    <span className="text-[10px] font-mono text-brand-gold font-bold">Auteur de solutions fiscales</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                <div className="md:col-span-7 glass-panel p-6 rounded-2xl border-l-4 border-l-brand-gold">
                  <h4 className="font-bold text-foreground text-base font-display">Guide de la Révolution & Congrès 2026</h4>
                  <p className="text-xs md:text-sm text-foreground/75 leading-relaxed mt-2 font-sans">
                ...
                <div className="md:col-span-5 bg-emerald-50/70 dark:bg-brand-green-dark/30 border border-brand-emerald/15 p-6 rounded-2xl flex flex-col justify-between">
